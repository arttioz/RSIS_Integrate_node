...
class ProjectIntegrateFinalEMS extends Model { }

ProjectIntegrateFinalEMS.init(
    {
        ...
        ems_id: DataTypes.BIGINT(20),
        ems_protocal: DataTypes.STRING(255),
    ...
    {
        sequelize: dbServer,
        tableName: 'project_integrate_final_ems',
        underscored: true,
        timestamps: true,
...
module.exports = ProjectIntegrateFinalEMS;
