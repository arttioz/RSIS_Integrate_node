...
class IntegrateFinalFullStage extends Model { }

IntegrateFinalFullStage.init({
    ...
    aaumpor_code: { type: DataTypes.INTEGER },
    ...
    alat: { type: DataTypes.DOUBLE },
    along: { type: DataTypes.DOUBLE },
    ...
    tableName: 'integrate_final_full_stage', // Adjust to match your actual table name
    timestamps: true, // Set to false if your table does not have createdAt and updatedAt
    createdAt: 'created_at',
    updatedAt: 'updated_at',
    modelName: 'IntegrateFinalFullStage',
});

module.exports = IntegrateFinalFullStage;